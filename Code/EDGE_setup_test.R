...
# to install all of the packages, I also had to install the following via terminal (UNIX shell)

#  sudo apt install libmagick++-dev
# sudo apt install libssl-dev


# for my fish project, I also installed "fishtree" package. 
# Citation for fishtree: Jonathan Chang, Daniel L. Rabosky, Stephen A. Smith, Michael E. Alfaro (2019). 
# An R package and online resource for macroevolutionary studies using the ray‐finned fish tree of life. 
# Methods in Ecology and Evolution, 10:1118–1124 doi:10.1111/2041-210x.13182
