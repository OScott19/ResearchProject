# This script is a test script in why I play about with the IUCN Red List API
...
# downloaded the Red List data for Actinopterygii - 19k results!

#import whole dataset
redlist.all <- read.csv("../../Data/RedListDownload.csv")

#create vector with just the data we need right now
redlist <- c()

redlist$Redlist.species <- as.character(redlist.all$scientificName)
redlist$redlistCategory <- as.character(redlist.all$redlistCategory)
