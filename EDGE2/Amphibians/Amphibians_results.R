...
load("Results/Amphibians_HPCResults_500only.Rdata")
...
for (i in 1:1000) {
  ...
  exp.PD.list <- NA
  exp.PD.trees <- NA
  to.load <- paste("Results/Amphibian_EDGE2_run", i, ".Rdata", sep = "")
...
#  load in the final missing results

save(EDGE.2.list, exp.PD.list, exp.PD.trees, file = "Results/Amphibians_HPCResults.Rdata")

#load("../Amphibians/Results/Amphibians_HPCResults_500only.Rdata")
