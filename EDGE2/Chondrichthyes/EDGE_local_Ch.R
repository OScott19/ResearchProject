...
tree.to.load <- paste("UpdatedTrees/ChtreeUpdated_", iter, ".Rdata", sep = "")
...
load("../Amphibians/pext_scores_for_EDGE2.RData") # called "data"
...
name_to_save <- paste("Ch_EDGE2_run", iter, ".Rdata", sep = "")
